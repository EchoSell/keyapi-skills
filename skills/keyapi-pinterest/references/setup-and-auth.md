...
2. search current docs with `node ./search-keyapi-docs.mjs --platform pinterest --query "<entity action>"`
...
$uri = "https://api.keyapi.ai/v1/pinterest/..."
...
Invoke-RestMethod -Method Post -Uri "https://api.keyapi.ai/v1/pinterest/..." -Headers $headers -Body $body
```
