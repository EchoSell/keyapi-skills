...
2. search current docs with `node ./search-keyapi-docs.mjs --platform facebook --query "<entity action>"`
...
$uri = "https://api.keyapi.ai/v1/facebook/..."
...
Invoke-RestMethod -Method Post -Uri "https://api.keyapi.ai/v1/facebook/..." -Headers $headers -Body $body
```
