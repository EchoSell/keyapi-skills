...
2. search current docs with `node ./search-keyapi-docs.mjs --platform twitter --query "<entity action>"`
...
$uri = "https://api.keyapi.ai/v1/twitter/..."
...
Invoke-RestMethod -Method Post -Uri "https://api.keyapi.ai/v1/twitter/..." -Headers $headers -Body $body
```
