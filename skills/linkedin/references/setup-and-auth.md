...
2. search current docs with `node ./search-keyapi-docs.mjs --platform linkedin --query "<entity action>"`
...
$uri = "https://api.keyapi.ai/v1/linkedin/..."
...
Invoke-RestMethod -Method Post -Uri "https://api.keyapi.ai/v1/linkedin/..." -Headers $headers -Body $body
```
