...
8. Search current docs with `node ./search-keyapi-docs.mjs --platform linkedin --query "<entity action>"` when the helper script is available; otherwise open `https://docs.keyapi.ai/llms.txt` directly.
