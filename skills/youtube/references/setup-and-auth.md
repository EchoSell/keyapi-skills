...
2. search current docs with `node ./search-keyapi-docs.mjs --platform youtube --query "<entity action>"`
...
$uri = "https://api.keyapi.ai/v1/youtube/..."
...
Invoke-RestMethod -Method Post -Uri "https://api.keyapi.ai/v1/youtube/..." -Headers $headers -Body $body
```
