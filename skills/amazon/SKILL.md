...
Route natural-language Amazon requests into documentation-guided KeyAPI REST workflows. This skill contains no local execution wrapper and no gateway dependency.
...
4. Read `references/amazon-rules.md` for Amazon-specific identifiers, pagination, and composition notes.
5. If auth is not configured, route to `references/setup-and-auth.md`.
6. Search `https://docs.keyapi.ai/llms.txt` for the relevant `amazon` docs page.
...
- `references/amazon-rules.md` - platform-specific entity and identifier rules.
