...
2. search current docs with `node ./search-keyapi-docs.mjs --platform google --query "<entity action>"`
...
$uri = "https://api.keyapi.ai/v1/google/..."
...
Invoke-RestMethod -Method Post -Uri "https://api.keyapi.ai/v1/google/..." -Headers $headers -Body $body
```
