...
8. Search current docs with `node ./search-keyapi-docs.mjs --platform tiktok --query "<entity action>"` when the helper script is available; otherwise open `https://docs.keyapi.ai/llms.txt` directly.
