...
Route natural-language TikTok requests into documentation-guided KeyAPI REST workflows. This skill contains no local execution wrapper and no gateway dependency.
...
4. Read `references/tiktok-rules.md` for TikTok-specific identifiers, pagination, and composition notes.
5. If auth is not configured, route to `references/setup-and-auth.md`.
6. Search `https://docs.keyapi.ai/llms.txt` for the relevant `tiktok` docs page.
...
- `references/tiktok-rules.md` - platform-specific entity and identifier rules.
