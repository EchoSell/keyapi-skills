...
2. search current docs with `node ./search-keyapi-docs.mjs --platform threads --query "<entity action>"`
...
$uri = "https://api.keyapi.ai/v1/threads/..."
...
Invoke-RestMethod -Method Post -Uri "https://api.keyapi.ai/v1/threads/..." -Headers $headers -Body $body
```
